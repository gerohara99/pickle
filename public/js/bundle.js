...
exports.updateEventPubJs = exports.eventUpdateMatchScorePubJs = exports.eventCreateBookingPubJs = exports.eventCancelBookingPubJs = exports.deleteEventPubJs = exports.createEventPubJs = void 0;
require("core-js/modules/es6.array.copy-within.js");
require("core-js/modules/es6.array.fill.js");
require("core-js/modules/es6.array.filter.js");
require("core-js/modules/es6.array.find.js");
...
var createEventPubJs = exports.createEventPubJs = /*#__PURE__*/function () {
  ...
  return function createEventPubJs(_x) {
    return _ref.apply(this, arguments);
  };
}();
var updateEventPubJs = exports.updateEventPubJs = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "/api/v1/events/".concat(data.eventId),
            data: data
          });
        case 3:
          res = _context2.sent;
  ...
  return function updateEventPubJs(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var deleteEventPubJs = exports.deleteEventPubJs = /*#__PURE__*/function () {
  ...
  return function deleteEventPubJs(_x3) {
...
var eventCreateBookingPubJs = exports.eventCreateBookingPubJs = /*#__PURE__*/function () {
  ...
  return function eventCreateBookingPubJs(_x4) {
...
var eventCancelBookingPubJs = exports.eventCancelBookingPubJs = /*#__PURE__*/function () {
  ...
  return function eventCancelBookingPubJs(_x5) {
    return _ref5.apply(this, arguments);
  };
}();
var eventUpdateMatchScorePubJs = exports.eventUpdateMatchScorePubJs = /*#__PURE__*/function () {
  ...
  return function eventUpdateMatchScorePubJs(_x6) {
...
var deleteUserPubJs = exports.deleteUserPubJs = /*#__PURE__*/function () {
  ...
  return function deleteUserPubJs(_x0) {
    return _ref3.apply(this, arguments);
  };
}();
...
if (scoreButtons) scoreButtons.forEach(function (item) {
  return item.addEventListener("click", function (e) {
    e.preventDefault(); // Prevent default behavior

    // Extract data attributes from the button
    var round = item.getAttribute("data-round");
    var matchIndex = item.getAttribute("data-matchindex");
    var eventId = item.getAttribute("data-eventid"); // Extract eventId
...
if (scoreForm) {
  scoreForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formData, data, eventId, locationPath;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            locationPath = "/events/viewMySchedule/" + eventId;
