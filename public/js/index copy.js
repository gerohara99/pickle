...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Optional: Close drawer when clicking outside or on a link (nice UX)
  ...
  // Optional: Close drawer when clicking any nav link inside drawer
